...
This represents an ability to <code>receive</code> an object of type <code>T</code>.
...
argument referencing an object owned by <code>parent</code> use the <code>to_receive</code> argument
to receive and return the corresponding owned object.
